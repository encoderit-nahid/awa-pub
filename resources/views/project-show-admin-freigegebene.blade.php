                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      ...
                      <div class="col-xs-4 col-sm-4 col-md-4 col-lg-4">
                        <form action="{{url('/project-freigegebene')}}">
                          @csrf
                          <div class="input-group mb-3">
                            ...
                            <div class="input-group-append">
                              <button type="submit" class="btn btn-outline-secondary" type="button">Suchen</button>
                            </div>
                          </div>
                        </form>
                      </div>
...
<div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header text-center">
                <h4 class="modal-title w-100 font-weight-bold">Grund für den Mangel</h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button class="btn btn-deep-orange" id="model-send-email">E-Mail senden und Status ändern</button>
...
$(document).ready(function() {
    ...
    $(document).on("change","#category",function(){
      var url      = '/project-freigegebene/'+$(this).val();
    ...
    $(document).on('click', '.action-add-jury', function(){
      $.ajax({
          url: "{{ url('/project-jury-add-admin') }}",
          type: 'POST',
            headers: {
              'X-CSRF-TOKEN': token
            },
    ...
    $(document).on('click', '.action-remove-jury', function(){
      $.ajax({
          url: "{{ url('/project-jury-remove-admin') }}",
          type: 'POST',
            headers: {
              'X-CSRF-TOKEN': token
            },
