        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="youtube-video-upload-form" method="POST" action="{{ route('change-project') }}"
                            ...
                            <div class="form-group row">
                                <label for="extra"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Infos zur Musiklizenz*') }}</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    Erlaubte Wörter: {{ $cats->words }} - Wörter total : <span
                                        id="display_count_extra">0</span> Wörter!
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input type="checkbox" checked="checked" name="check" id="check"
                                        ...
                                        <p>Ich habe das Recht das Video und die Musik zu verwenden!</p>
                                    </label>
                                    @if ($errors->has('check'))
                                        <span class="invalid-feedback">
