    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                      ...
                      <br>
						 @if($user->rolle === 9)
							  @if($project->special==0)
								  <button class="btn btn-primary action-special" dataValue="1" id="{{$project->id}}">Make Special</button>
								  @else
								  <button class="btn btn-primary action-special" dataValue="0" id="{{$project->id}}">Make - Not Special</button>
							  @endif
						  @endif
              @if($project->youtube !="")
              ...
              @endif
                          <p style=""><b>Firma: {{ $current_user->firma }}
                          ...
                          <div class="form-group">
                              ...
                              <textarea class="form-control" rows="5" id="comment">{{$project->beschreibung }} {{$project->testimonial}} {{$project->extra}} {{$project->ort}} - {{$project->datum}}
                              </textarea>
                          </div>
                          <br>
                          <div class="row">
                          ...
                          @foreach($project->images as $image)
                            ...
                            <div class="column" id = "thumb-<?php echo md5($filename)?>">
                              <img src="{{ url($thumb_url) }}" alt="{{$filename}}" style="width:70%;height:70%" onclick="openModal('{{$project->projektname}}');currentSlide(<?php echo $imageCount ?> , '<?php echo $project->projektname?>')" class="hover-shadow demo-<?php echo $project->projektname ?> cursor">
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer d-flex justify-content-center">
                <button class="btn btn-deep-orange" id="model-send-email">Send Email & Projekt zurückweisen</button>
