            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        ...
                        <div class="link-div" style="text-align: center;width: 100%;display: inline-table;"><a class="btn btn-success" href="/public-votable" id="{{1}}">Veröffentlichte Projekte zur öffentlichen Abstimmung</a></div>
                    </div>
                    <div class="card-body">
              ...
              */
                                        ...
                                        <button class="btn btn-primary action-accept" id="{{$project->id}}">zur öffentlichen Abstimmung veröffentlichen</button>
                                        <hr/>
                                        <div style="height: 30px;"></div>
                            @endforeach
                        </section>
