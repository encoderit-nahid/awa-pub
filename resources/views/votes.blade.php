                ...
                <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <section class="projects endless-pagination" data-next-page="">
                                @foreach ($projects as $project)
                                    <p style="">
                                        {{-- <b>Kategorie: {{ $project->cat_name }}</b> --}}
                                            <p style="">
                                                <b>Projektname: {{ $project->projektname }} ID: {{ $project->id }}</b>
                                            </p>
                                            <br>
                                            @if ($project->youtube != '')
                                ...
                                <!-- <iframe src="{{ $project->youtube }}" height="280px" width="640px" allowfullscreen></iframe> -->
                                            ...
                                            <div class="row">
                                                ...
                                                @foreach ($project->images as $image)
                                                    ...
                                                    <div class="column" id="thumb-<?php echo md5($filename); ?>">
                                                        <img src="{{ 'https://app.austrianweddingaward.at/'.$thumb_url }}" alt="{{ $filename }}"
                                            ...
                                            <form method="POST" action="{{ route('public-project-rated') }}">
                                                @csrf
                                                {{ Form::hidden('cat_id', $cat_id) }}
                                                {{ Form::hidden('project_id', $project->id) }}
                                                <label for="Cat"></label>
                                                <select class="form-control" name="counts" id="counts"
                                                    data-parsley-required="true" onchange='this.form.submit()'>
                                                            ...
                                                            <div
                                                                ...
                                                                @foreach ($project->images as $image)
                                                                    ...
                                                                    <div class="mySlides-<?php echo $project->projektname; ?> w-auto-h-100"
                                                                        ...
                                                                        <img src="{{ 'https://app.austrianweddingaward.at/'.$url }}"
                                                                        ...
                                                                        <div class="column clearfix"
                                                                            ...
                                                                            <div class="image-wrapper">
                                                                                <img id="slideimg-<?php echo md5($image->filename); ?>"
                                                                                    ...
                                                                                    src="{{ 'https://app.austrianweddingaward.at/'.$thumb_url }}"
                                                                                    style="width:100%"
