              ...
              <div class="card-body">
                    <form method="POST" action="{{ route('change-project') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="datum" type="text" value="{{ $project->datum }}" class="form-control{{ $errors->has('datum') ? ' is-invalid' : '' }}" name="datum" value="{{ old('datum') }}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="ort" type="text" value="{{ $project->ort }}" class="form-control{{ $errors->has('ort') ? ' is-invalid' : '' }}" name="ort" value="{{ old('ort') }}" required>
