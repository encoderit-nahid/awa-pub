            ...
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('vote-register') }}">
                            @csrf
                                    ...
                                    <div class="checkbox">
                                        <label>
                                            <input id="confirm" type="checkbox" name="confirm"
                                                ...
                                                Ich bin damit einverstanden, dass meine hier angegebenen Daten zur Bearbeitung der Einreichung verwendet werden.
                                        </label>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    ...
                                    {{-- <a class="btn btn-link" href="{{ route('votes') }}">
                                        {{ __('Jetzt voten') }}
                                    </a> --}}
                                </div>
                            </div>
