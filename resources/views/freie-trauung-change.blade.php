                        ...
                        <form method="POST" action="{{ route('change-project') }}">
                            ...
                            <div class="form-group row">
                                <label for="beschreibung"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Beschreibung  mit Kontaktdaten*') }}</label>
                            ...
                            <div class="form-group row">
                                <label for="testimonial"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Referenz*') }}</label>
                                ...
                                <div class="col-md-6">
                                    ...
                                    Erlaubte Wörter: <span class="testimonial-word-limit">{{-- $cats->words --}} 300</span> -
