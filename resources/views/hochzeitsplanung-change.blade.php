                        ...
                        <form method="POST" action="{{ route('change-project') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    Erlaubte Wörter: <span class="testimonial-word-limit">{{-- $cats->words --}} 600</span> -
                                    Wörter total : <span id="display_count_referenz">0</span> Wörter!
                            ...
                            <div class="form-group row">
                                <label for="extra"
                                    class="col-md-4 col-form-label text-md-right">{{ __('Weitere Informationen*') }}</label>
