<form method="POST" action="{{ route('add-project') }}">
    ...
    <div class="form-group row">
        ...
        <div class="col-md-6">
            <select name="user_id" id="input" class="form-control" required="required" autofocus>
    ...
    <div class="form-group row">
        <label for="datum" class="col-md-4 col-form-label text-md-right">{{ __('Datum der Firmengründung*') }}</label>
    ...
    <div class="form-group row">
        <label for="ort" class="col-md-4 col-form-label text-md-right">{{ __('Ort der Firmengründung*') }}</label>
